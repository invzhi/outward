...
const (
	WorkspaceService_CreateWorkspace_FullMethodName  = "/outward.v1.WorkspaceService/CreateWorkspace"
	WorkspaceService_GetWorkspaceList_FullMethodName = "/outward.v1.WorkspaceService/GetWorkspaceList"
)
...
func (c *workspaceServiceClient) GetWorkspaceList(ctx context.Context, in *GetWorkspaceListRequest, opts ...grpc.CallOption) (*GetWorkspaceListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetWorkspaceListResponse)
	err := c.cc.Invoke(ctx, WorkspaceService_GetWorkspaceList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WorkspaceService_GetWorkspaceList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkspaceService_GetWorkspaceList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkspaceServiceServer).GetWorkspaceList(ctx, req.(*GetWorkspaceListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WorkspaceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "outward.v1.WorkspaceService",
	...
	Metadata: "outward/v1/workspace_service.proto",
}
